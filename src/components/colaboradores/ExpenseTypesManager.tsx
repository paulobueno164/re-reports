...
export const ExpenseTypesManager = ({ colaboradorId, disabled = false }: ExpenseTypesManagerProps) => {
  ...
  const fetchData = async () => {
    ...
    // Fetch linked types for this colaborador
    ...
    const linkedMap = new Map<string, ColaboradorTipoDespesa>();
    links?.forEach(link => {
